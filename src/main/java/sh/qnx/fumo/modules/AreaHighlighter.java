...
public class AreaHighlighter extends Module {
    ...
    private final Setting<Double> boxHeight = sgRender.add(new DoubleSetting.Builder()
        .name("box-height")
        .description("Height of the box to render")
        .defaultValue(1)
        .range(0, 400)
        .sliderRange(0, 128)
        .build()
        ...
        switch (areaType.get()) {
            case RegionFile:
                event.renderer.box(
                    ...
                    getEdge(pos.x) - 512, yLevelToUse + boxHeight.get(), getEdge(pos.z) - 512,
            ...
            case MapArt:
                event.renderer.box(
                    ...
                    getMapCenter(pos.x) + 64, yLevelToUse + boxHeight.get(), getMapCenter(pos.z) + 64,
                    sideColor.get(), lineColor.get(), shapeMode.get(), 0
                );
                break;
        }
