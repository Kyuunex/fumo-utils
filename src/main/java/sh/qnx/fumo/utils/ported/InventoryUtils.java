...
public class InventoryUtils {
    ...
    public static void dropSlot(AbstractContainerMenu container, int i, boolean stack) {
        ...
        mc.gameMode.handleContainerInput(container.containerId, i, stack ? 1 : 0, ContainerInput.THROW, mc.player);
    }
    ...
    public static void swapToHotbar(int slot, int hot) {
        ...
        mc.gameMode.handleContainerInput(mc.player.containerMenu.containerId, slot, hot, ContainerInput.SWAP, mc.player);
    }
    ...
    public static void placeItem(int slot) {
        ...
        // mc.gameMode.handleContainerInput(mc.player.containerMenu.containerId, -999, 0, ContainerInput.THROW, mc.player);
        mc.gameMode.handleContainerInput(mc.player.containerMenu.containerId, slot, 1, ContainerInput.PICKUP, mc.player);
    }
