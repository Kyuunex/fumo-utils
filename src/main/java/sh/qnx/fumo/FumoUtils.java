...
import sh.qnx.fumo.commands.*;
import sh.qnx.fumo.modules.*;
import sh.qnx.fumo.modules.ported.*;
import sh.qnx.fumo.modules.highwaytools.*;
...
public class FumoUtils extends MeteorAddon {
    ...
    public static final Category CATEGORY = new Category("Fumo Utils");
    public static final Category HIGHWAY = new Category("Highway Tools");

    @Override
    public void onInitialize() {
        LOG.info("Initializing Fumo Utils");
    ...
    public GithubRepo getRepo() {
        return new GithubRepo("qnxt", "fumo-utils");
    }
}
